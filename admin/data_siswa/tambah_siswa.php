        ...
        <div class="wrapper">
            ...
            <nav id="sidebar" style="background-color: #808080;">
                <div class="sidebar-header" style="background-color: #808080;">
                    <a href="../index-admin.php" style="background-color: #808080;">
            ...
            <div class="container-fluid" id="content">
                ...
                <div class="panel-body">
                 ...
                 <form class="form" action="proses_tambah_siswa.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" name="lahir" class="form-control" max="<?php echo date('1999-12-31'); ?>"  >
                    </div>
            ...
            <div class="form-group">
              ...
              <input type="submit" required name="nanam" value = "Simpan" class="btn btn-success btn-fill pull-left" onclick="return confirm('Apa anda yakin dengan Penambahan data Siswa?');">
        </div>
                  </form>
